...
import it.ul.team.crmsystemstartup.security.JwtErrors;
import it.ul.team.crmsystemstartup.security.JwtTokenFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/auth/**", "/api/category/**", "/api/aware/**", "/api/product/**", "/api/comment/**",  "/api/attachment/**", "/api/buy-products/**", "/api/country/**")
                .permitAll()
                .antMatchers("/api/**")
                .authenticated();
